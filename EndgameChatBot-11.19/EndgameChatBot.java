 ...
 * @author Siri, Celine, and Rina
 * @version November 2019
 */

public class EndgameChatBot extends NameGame
{  
    /**
    ...
    public String getGreeting()
    {
        ...
        findKeyword("clint hawkeye hair", "hair", 0);
    ...
    public String getResponse(String statement)
    {
        ...
        {
                response = "Thanos snapped half Clint's hair away too.";
        }
    ...
    private String getRandomResponse()
    {
        ...
        {
           response = "Would you like to play the name game? If so, please say 'name game'";
        }
